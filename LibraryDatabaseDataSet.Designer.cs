...
namespace LibraryProject {
    ...
    public partial class LibraryDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, string Description, int Quantity) {
...
namespace LibraryProject.LibraryDatabaseDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ([Quantity] = @Origina" +
                "l_Quantity))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Title], [Author], [Description], [Quantity]) VALUES (" +
                "@Title, @Author, @Description, @Quantity);\r\nSELECT Id, Title, Author, Descriptio" +
                "n, Quantity FROM Books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [Description] = @Description, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ([Quantity] = @Original_Quantity));
SELECT Id, Title, Author, Description, Quantity FROM Books WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, Author, Description, Quantity FROM dbo.Books";
        ...
        public virtual int Insert(string Title, string Author, string Description, int Quantity) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, string Description, int Quantity, int Original_Id, int Original_Quantity, int Id) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Description, int Quantity, int Original_Id, int Original_Quantity) {
            return this.Update(Title, Author, Description, Quantity, Original_Id, Original_Quantity, Original_Id);
        }
    }
